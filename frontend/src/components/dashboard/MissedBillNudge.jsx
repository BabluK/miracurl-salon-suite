...
export function MissedBillNudge() {
  ...
  return (
    <div className="rounded-2xl border border-amber-200 bg-gradient-to-br from-amber-50 via-white to-orange-50 shadow-sm overflow-hidden" data-testid="missed-bill-nudge">
