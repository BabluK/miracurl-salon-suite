...
import { ShieldCheck, KeyRound, Eraser, Download, ChevronDown } from "lucide-react";
...
export function AuditLogCard() {
  ...
  return (
    <div className="mt-6 bg-white border border-slate-200 rounded-2xl p-5" data-testid="audit-log-card">
      ...
      <p className="text-xs text-slate-400 mb-4">A trail of sensitive actions — every Owner PIN use, data erase and export is recorded here.</p>
      {items.length === 0 ? (
