...
// YouTube IDs verified 17 Sep 2026 (watch-page playabilityStatus OK + playableInEmbed). Re-verify live streams monthly — Lofi Girl radios ended.
export const MUSIC_CHANNELS = [
  ...
  { id: "spa", label: "Spa Vibes", desc: "Flying — 3 hours of calm spa & meditation music", yt: "1ZYbU82GVz4", spotify: "37i9dQZF1DX1s9knjP51Oa", icon: Waves, tint: "bg-cyan-100 text-cyan-700 border-cyan-200", instrumental: true },
  { id: "positive", label: "Positive Energy", desc: "The Good Life Radio — 24/7 uplifting chill-house, feel-good energy", yt: "36YnV9STBqc", spotify: "37i9dQZF1DX3Ogo9pFvBkY", icon: Sparkles, tint: "bg-amber-100 text-amber-700 border-amber-200", instrumental: true },
  ...
  { id: "hits", label: "Bollywood Hot Hits", desc: "24/7 live nonstop Hindi hits", yt: "iLXM4Io4O4o", spotify: "37i9dQZF1DX0XUfTFmNBRM", icon: Flame, tint: "bg-rose-100 text-rose-700 border-rose-200" },
