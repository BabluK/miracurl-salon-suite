...
export default function Terms() {
  return (
    <div className="min-h-screen bg-neutral-950 text-white" data-testid="terms-page">
      <header className="border-b border-white/10">
        <div className="max-w-3xl mx-auto px-6 py-5 flex items-center justify-between">
          <Link to="/" className="flex items-center gap-2 text-sm text-neutral-300 hover:text-white transition-colors" data-testid="terms-back-home">
            <Scissors className="w-4 h-4 text-fuchsia-400" /> Miracurl Salon Suite
          </Link>
          <Link to="/privacy" className="text-xs text-neutral-500 hover:text-white transition-colors" data-testid="terms-privacy-link">Privacy Policy →</Link>
        </div>
      </header>
      ...
      <main className="max-w-3xl mx-auto px-6 py-14">
        ...
        <h1 className="font-playfair text-4xl sm:text-5xl mb-3">Terms of Service</h1>
        <p className="text-sm text-neutral-500 mb-12">Last updated: June 2026 · These terms govern your use of Miracurl Salon Suite.</p>
        ...
        <S n="12" title="Governing law & contact">
          <p>These terms are governed by the laws of India, and the courts of Bangalore, Karnataka shall have exclusive jurisdiction over any dispute. Questions about these terms? Write to us at <a href="mailto:legal@miracurl.com" className="text-fuchsia-400 hover:underline">legal@miracurl.com</a>.</p>
        </S>
