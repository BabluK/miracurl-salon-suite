  ...
  return (
    <LegalLayout testId="privacy-page" label="LEGAL" title="Privacy Policy"
      ...
      <S n="8" title="Your rights">
        ...
        <p>To exercise any of these rights, email <a href="mailto:legal@miracurl.com">legal@miracurl.com</a>. If you are a salon's customer, please contact the salon directly first — they control your booking records.</p>
      </S>
      ...
      <S n="12" title="Contact us">
        <p>For any privacy question, request or complaint, contact our privacy team at <a href="mailto:legal@miracurl.com">legal@miracurl.com</a>. Miracurl Salon Suite, Bangalore, Karnataka, India.</p>
      </S>
    </LegalLayout>
  );
}
