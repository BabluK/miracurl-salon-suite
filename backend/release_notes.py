...
BUILD_LOG = [
    {"build": "2026-09-21.336", "note": "Branch picker + denied popup: warm-lit salon background (assets/branch-gate/bg-warm.jpg) inside the card AND as the blurred page backdrop; lighter overlays (40%/60%). Denied popup rebuilt to mockup (Oops! layout, phone-map, nearest branch + directions, trust row)."},
