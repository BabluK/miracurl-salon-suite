...
from services.rewards_core import (  # noqa: E402,F401 — canonical home is services/rewards_core.py
    CAMPAIGN_DEFAULTS, DEFAULT_CAMPAIGN, DEFAULT_RESTAURANT_CAMPAIGN, get_campaign, get_campaign_for, get_campaign_for_slug, _tenant_eligible,
    _campaign_events, _now, campaign_id_for, _plan_matches,
)
