...
PLAN_CATALOG = {
    ...
    "intl_starter_monthly":  {"label": "Starter Monthly (USD)",      "price": 39.0,   "duration_days": 31,  "branches": 1, "currency": "USD", "tier": "starter"},
    "intl_starter_annual":   {"label": "Starter Annual (USD)",       "price": 390.0,  "duration_days": 365, "branches": 1, "currency": "USD", "tier": "starter"},
    "intl_pro_monthly":      {"label": "Professional Monthly (USD)", "price": 79.0,   "duration_days": 31,  "branches": 1, "currency": "USD", "tier": "professional"},
    "intl_pro_annual":       {"label": "Professional Annual (USD)",  "price": 790.0,  "duration_days": 365, "branches": 1, "currency": "USD", "tier": "professional"},
    "intl_premium_monthly":  {"label": "Premium AI Monthly (USD)",   "price": 149.0,  "duration_days": 31,  "branches": 1, "currency": "USD", "tier": "premium"},
